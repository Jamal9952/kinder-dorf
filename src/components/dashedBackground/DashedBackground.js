...
const DashedBackground = (props) => {
  return (
    <div className={props.className ? props.className : "dashed-background-container"}  style={{ backgroundColor: `${props.color}` , borderRadius:`${props.radius}`, width:`${props.width}` }}>
